    ...
    <>
      <div className="min-h-screen bg-[#EEF1F9]  flex items-center  overflow-hidden w-full">
        <div className="min-h-screen basis-full flex flex-wrap w-full  justify-center overflow-y-auto">
          <div className="basis-1/2 bg-[#EEF1F9] w-full  relative hidden xl:flex justify-center items-center bg-gradient-to-br from-green-800 via-green-600 to-green-800"
          >
            <img
              src="/image/line.png"
              alt="image"
            ...
            />
            <div className="relative z-10 backdrop-blur bg-green-200/40 py-14 px-16 2xl:py-[84px] 2xl:pl-[50px] 2xl:pr-[136px] rounded max-w-[640px]">
              <div>
                ...
                <div className="text-4xl leading-[50px] 2xl:text-6xl 2xl:leading-[72px] font-semibold mt-2.5">
                  ...
                  <div className="mt-5 2xl:mt-8 text-gray-900  text-2xl font-medium">
