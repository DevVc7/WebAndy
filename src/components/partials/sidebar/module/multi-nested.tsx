            ...
            >
              <Link to={item.href!} className="">
                <div>
                  <div
                    className={cn(
                      "pl-2  text-sm font-normal capitalize hover:text-green-300 gap-2 flex items-center group  text-green-700 ",
                    )}
                  >
                    <span
                      className={cn(
                        "inline-flex h-2 w-2  border  rounded-full  ring-green-500/30   ring-[4px]  border-green-500  ",
                      )}
                    ></span>
