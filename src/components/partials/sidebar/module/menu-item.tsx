  ...
  return (
    <Link
      ...
      className={cn(
        ...
        {
          "bg-green-600 text-white ": isLocationMatch(
            childItem.href!,
            pathname
          ),
    ...
    <div>
      {childItem?.nested ? (
        ...
        >
          ...
          >
            <span className="inline-flex items-center  flex-grow-0 text-gray-500">
          ...
          {childItem.nested && (
            <div
              className={cn(
                "flex-none transition-all duration-200 text-gray-500 ",
                {
                  "transform rotate-90   text-green-700":
                    nestedIndex === index,
                }
              )}
            >
