...
const FooterMenu = () => {
  ...
  return (
    <div className="space-y-5 flex flex-col items-center justify-center pb-6">
      <button className="w-10 h-10  mx-auto text-gray-500 flex items-center justify-center  rounded-md transition-all duration-200 hover:bg-green-600/20 hover:text-green-500">
