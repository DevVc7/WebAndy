  ...
  return (
    <Collapsible open={nestedIndex === index}>
      <CollapsibleContent className="CollapsibleContent">
        <ul className="sub-menu space-y-3 relative before:absolute before:left-4 before:top-0  before:h-[calc(100%-5px)]  before:w-[2px] before:bg-green-500/10 dark:before:bg-green-500/20 before:rounded">
          {nestedMenus?.map((item, j: number) => (
            <li
              className={cn(
                ...
                {
                  "before:bg-green-500 first:before:h-[calc(100%-16px)]  before:h-full":
